...
この度は、ARTISAN PROJECTのプログラムをご利用いただきましてありがとうございます。
利用規定は、ARTISAN PROJECT 利用規定に準拠します。

写しを、添付してありますので参考にしてください。

なお、このライブラリは、どなたでも無料でご利用になれます。
