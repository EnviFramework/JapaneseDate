...
class JapaneseDate
{
    ...
    {
        $this->lc = \JapaneseDate\LunarCalendar::factory();
    ...
    public static function factory()
    {
        static $instance;
        if (!$instance) {
            $instance = new \JapaneseDate\JapaneseDate;
        }
        return $instance;
    }
    /* ----------------------------------------- */
    ...
    public function getHolidayList(JapaneseDateTime $JapaneseDateTime)
    {
        ...
        return $this->$methods[$JapaneseDateTime->getMonth()]($JapaneseDateTime->getYear(), $JapaneseDateTime->getTimezone());
